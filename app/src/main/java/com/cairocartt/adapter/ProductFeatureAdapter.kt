...
import com.cairocartt.databinding.ItemProductherozantleBinding
import com.cairocartt.databinding.RowProductBinding
import com.cairocartt.databinding.RowProductgridBinding
import kotlinx.android.synthetic.main.item_productherozantle.view.*

class ProductFeatureAdapter (context: Context, var productData: ProductItemListener) :
...
//    }
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, type: Int): RecyclerView.ViewHolder {
            ...
            return ProductsGridViewHolder(
                ItemProductherozantleBinding.inflate(
    ...
    inner class ProductsGridViewHolder(var mTradersResponse: ItemProductherozantleBinding) :
